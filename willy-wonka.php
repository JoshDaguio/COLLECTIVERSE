                    ...
                    <div class="product__images col--6">
                        ...
                        <div class="wrapper">
                            <div class="image-container" id="js-main-image-wrapper">
                                <img src="assets\img\funko-pops-outside-the-box\willy-wonka-otb.png" 
                                     class="js-main-image" title="POP! WILLY WONKA WITH BRIEFCASE" alt="POP! WILLY WONKA WITH BRIEFCASE" itemprop="image" />
                            </div>
                            ...
                            <div class="images__thumbs clearfix">
                                <div id="thumb1" class="image-container thumb active">
                                    <img style="height:50px !important;width:50px !important;" 
                                         src="assets\img\funko-pops-outside-the-box\willy-wonka-otb.png" 
                                         alt="POP! WILLY WONKA WITH BRIEFCASE">
                                </div>
                                <div id="thumb2" class="image-container thumb">
                                    <img style="height:50px !important;width:50px !important;" 
                                         src="assets\img\funko-pops-inside-the-box\willy-wonka-itb.png" 
                                         alt="POP! WILLY WONKA WITH BRIEFCASE">
                                </div>
                            </div>
                    ...
                    <div id="BuyBoxArea" class="product__data col--6">
                        <div class="wrapper">
                            ...
                            <div class="row">
                                ...
                                <h1 itemprop="name">POP! WILLY WONKA WITH BRIEFCASE</h1>
                            ...
                            <form method="post" action="add-to-cart.php">
                                ...
                                <div class="product__qty">
                                    ...
                                    <input type="text" name="quantity_11" value="1" min="1"></label>
                                </div>

                                <div class="product__description funko-pop-text">
                                    You’re in for a real treat! Build your chocolate empire with Pop! Willy Wonka™ by welcoming this confectionary visionary 
                                    into your Wonka™ collection! Vinyl figure is approximately 4.9-inches tall.
                                </div>
                                ...
                                <div class="product__mod">
                                    <div class="product__basket">
                                        ...
                                        <script>
                                            function qtyUpdate() {
                                                document.getElementById("Qty").value = document.getElementById("quantity_11").value;
                                            }
                                        </script>
                                        ...
                                        <button id="add-to-basket" type="submit" value="11" name="add_to_cart" class="button light full-width tooltip">
