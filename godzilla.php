                    ...
                    <div class="product__images col--6">
                        ...
                        <div class="wrapper">
                            <div class="image-container" id="js-main-image-wrapper">
                                <img src="assets\img\funko-pops-outside-the-box\super-godzilla-otb.png" 
                                     class="js-main-image" title="POP! SUPER GODZILLA (THE NEW EMPIRE)" alt="POP! SUPER GODZILLA (THE NEW EMPIRE)" itemprop="image" />
                            </div>
                            ...
                            <div class="images__thumbs clearfix">
                                <div id="thumb1" class="image-container thumb active">
                                    <img style="height:50px !important;width:50px !important;" 
                                         src="assets\img\funko-pops-outside-the-box\super-godzilla-otb.png" 
                                         alt="POP! SUPER GODZILLA (THE NEW EMPIRE)">
                                </div>
                                <div id="thumb2" class="image-container thumb">
                                    <img style="height:50px !important;width:50px !important;" 
                                         src="assets\img\funko-pops-inside-the-box\super-godzilla-itb.png" 
                                         alt="POP! SUPER GODZILLA (THE NEW EMPIRE)">
                                </div>
                            </div>
                    ...
                    <div id="BuyBoxArea" class="product__data col--6">
                        <div class="wrapper">
                            ...
                            <div class="row">
                                ...
                                <h1 itemprop="name">POP! SUPER GODZILLA (THE NEW EMPIRE)</h1>
                                <div class="product__price" itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
                                    <span class="price" itemprop="price" content=""><span itemprop="priceCurrency" content="GBP">P</span>490.00</span>
                                </div>
                            </div>
                            ...
                            <form method="post" action="add-to-cart.php">
                                ...
                                <div class="product__qty">
                                    ...
                                    <input type="text" name="quantity_5" value="1" min="1"></label>
                                </div>

                                <div class="product__description funko-pop-text">
                                    Clear the way for a colossal adventure! Pop! Godzilla is ready to take on the latest threat raging in the MonsterVerse. 
                                    Godzilla and King Kong, two Titans, will face a challenge that looms larger than ever before. Capture your favorite movie
                                    moments from Godzilla x Kong: The New Empire and build your Pop! Movies set. Vinyl figure is approximately 5.1-inches tall.
                                </div>
                                <hr>
                                ...
                                <div class="product__mod">
                                    <div class="product__basket">
                                        ...
                                        <script>
                                            function qtyUpdate() {
                                                document.getElementById("Qty").value = document.getElementById("quantity_5").value;
                                            }
                                        </script>
                                        ...
                                        <button id="add-to-basket" type="submit" value="5" name="add_to_cart" class="button light full-width tooltip">
