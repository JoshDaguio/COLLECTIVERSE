                    ...
                    <div class="product__images col--6">
                        ...
                        <div class="wrapper">
                            <div class="image-container" id="js-main-image-wrapper">
                                <img src="assets\img\funko-pops-outside-the-box\hermione-granger-otb.png" 
                                     class="js-main-image" title="POP! HERMIONE GRANGER WITH CROOKSHANKS" alt="POP! HERMIONE GRANGER WITH CROOKSHANKS" itemprop="image" />
                            </div>
                            ...
                            <div class="images__thumbs clearfix">
                                <div id="thumb1" class="image-container thumb active">
                                    <img style="height:50px !important;width:50px !important;" 
                                         src="assets\img\funko-pops-outside-the-box\hermione-granger-otb.png" 
                                         alt="POP! HERMIONE GRANGER WITH CROOKSHANKS">
                                </div>
                                <div id="thumb2" class="image-container thumb">
                                    <img style="height:50px !important;width:50px !important;" 
                                         src="assets\img\funko-pops-inside-the-box\hermione-granger-itb.png" 
                                         alt="POP! HERMIONE GRANGER WITH CROOKSHANKS">
                                </div>
                            </div>
                    ...
                    <div id="BuyBoxArea" class="product__data col--6">
                        <div class="wrapper">
                            ...
                            <div class="row">
                                ...
                                <h1 itemprop="name">POP! HERMIONE GRANGER WITH CROOKSHANKS</h1>
                                <div class="product__price" itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
                                    <span class="price" itemprop="price" content=""><span itemprop="priceCurrency" content="GBP">P</span>690.00</span>
                                </div>
                            </div>
                            ...
                            <form method="post" action="add-to-cart.php">
                                ...
                                <div class="product__qty">
                                    ...
                                    <input type="text" name="quantity_10" value="1" min="1"></label>
                                </div>

                                <div class="product__description funko-pop-text">
                                    Pop! Hermione Granger™ is bringing a new pet along to Hogwarts™! Ron Weasley™ and Scabbers™ may not be happy about her feline 
                                    companion, but Pop! Hermione loves her cat, Pop! Crookshanks™. Celebrate the Harry Potter and the Prisoner of Azkaban™ movie 
                                    and expand your Wizarding World™ set by adding Pop! Hermione Granger™ and Pop! Crookshanks™ to your Harry Potter™ collection. 
                                    Vinyl figure is approximately 3.6-inches tall.
                                </div>
                                ...
                                <div class="product__mod">
                                    <div class="product__basket">
                                        ...
                                        <script>
                                            function qtyUpdate() {
                                                document.getElementById("Qty").value = document.getElementById("quantity_10").value;
                                            }
                                        </script>
                                        ...
                                        <button id="add-to-basket" type="submit" value="10" name="add_to_cart" class="button light full-width tooltip">
