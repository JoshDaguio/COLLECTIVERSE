                    ...
                    <div class="product__images col--6">
                        ...
                        <div class="wrapper">
                            <div class="image-container" id="js-main-image-wrapper">
                                <img src="assets\img\funko-pops-outside-the-box\all-might-otb.png" 
                                     class="js-main-image" title="POP! ALL MIGHT (TEXAS SMASH)" alt="POP! ALL MIGHT (TEXAS SMASH)" itemprop="image" />
                            </div>
                            ...
                            <div class="images__thumbs clearfix">
                                <div id="thumb1" class="image-container thumb active">
                                    <img style="height:50px !important;width:50px !important;" 
                                         src="assets\img\funko-pops-outside-the-box\all-might-otb.png" 
                                         alt="POP! ALL MIGHT (TEXAS SMASH)">
                                </div>
                                <div id="thumb2" class="image-container thumb">
                                    <img style="height:50px !important;width:50px !important;" 
                                         src="assets\img\funko-pops-inside-the-box\all-might-itb.png" 
                                         alt="POP! ALL MIGHT (TEXAS SMASH)">
                                </div>
                            </div>
                    ...
                    <div id="BuyBoxArea" class="product__data col--6">
                        <div class="wrapper">
                            ...
                            <div class="row">
                                ...
                                <h1 itemprop="name">POP! ALL MIGHT (TEXAS SMASH)</h1>
                                <div class="product__price" itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
                                    <span class="price" itemprop="price" content=""><span itemprop="priceCurrency" content="GBP">P</span>745.00</span>
                                </div>
                            </div>
                            ...
                            <form method="post" action="add-to-cart.php">
                                ...
                                <div class="product__qty">
                                    ...
                                    <input type="text" name="quantity_13" value="1" min="1"></label>
                                </div>

                                <div class="product__description funko-pop-text">
                                    All Might is a Pro Hero who uses his One For All quirk as a means for fighting against the League of Villains. Help this 
                                    exclusive Pop! All Might use his Texas Smash to battle the villains in your My Hero Academia collection alongside his fellow 
                                    heroes. Vinyl figure is approximately 5.5-inches tall.
                                </div>
                                ...
                                <div class="product__mod">
                                    <div class="product__basket">
                                        ...
                                        <script>
                                            function qtyUpdate() {
                                                document.getElementById("Qty").value = document.getElementById("quantity_13").value;
                                            }
                                        </script>
                                        ...
                                        <button id="add-to-basket" type="submit" value="13" name="add_to_cart" class="button light full-width tooltip">
