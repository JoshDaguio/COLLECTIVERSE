                    ...
                    <div class="product__images col--6">
                        ...
                        <div class="wrapper">
                            <div class="image-container" id="js-main-image-wrapper">
                                <img src="assets\img\funko-pops-outside-the-box\chimchar-otb.png" 
                                     class="js-main-image" title="POP! CHIMCHAR" alt="POP! CHIMCHAR" itemprop="image" />
                            </div>
                            ...
                            <div class="images__thumbs clearfix">
                                <div id="thumb1" class="image-container thumb active">
                                    <img style="height:50px !important;width:50px !important;" 
                                         src="assets\img\funko-pops-outside-the-box\chimchar-otb.png" 
                                         alt="POP! CHIMCHAR">
                                </div>
                                <div id="thumb2" class="image-container thumb">
                                    <img style="height:50px !important;width:50px !important;" 
                                         src="assets\img\funko-pops-inside-the-box\chimchar-itb.png" 
                                         alt="POP! CHIMCHAR">
                                </div>
                            </div>
                    ...
                    <div id="BuyBoxArea" class="product__data col--6">
                        <div class="wrapper">
                            ...
                            <div class="row">
                                ...
                                <h1 itemprop="name">POP! CHIMCHAR</h1>
                                <div class="product__price" itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
                                    <span class="price" itemprop="price" content=""><span itemprop="priceCurrency" content="GBP">P</span>695.00</span>
                                </div>
                            </div>
                            ...
                            <form method="post" action="add-to-cart.php">
                                ...
                                <div class="product__qty">
                                    ...
                                    <input type="text" name="quantity_9" value="1" min="1"></label>
                                </div>

                                <div class="product__description funko-pop-text">
                                    Your dream of becoming a Trainer is not out of reach! Catch this Pop! Chimchar to add to your Pokémon collection. Vinyl figure 
                                    is approximately 3.55-inches tall.
                                </div>
                                ...
                                <div class="product__mod">
                                    <div class="product__basket">
                                        ...
                                        <script>
                                            function qtyUpdate() {
                                                document.getElementById("Qty").value = document.getElementById("quantity_9").value;
                                            }
                                        </script>
                                        ...
                                        <button id="add-to-basket" type="submit" value="9" name="add_to_cart" class="button light full-width tooltip">
