                    ...
                    <div class="product__images col--6">
                        ...
                        <div class="wrapper">
                            <div class="image-container" id="js-main-image-wrapper">
                                <img src="assets\img\funko-pops-outside-the-box\harry-potter-otb.png" 
                                     class="js-main-image" title="POP! HARRY POTTER" alt="POP! HARRY POTTER" itemprop="image" />
                            </div>
                            ...
                            <div class="images__thumbs clearfix">
                                <div id="thumb1" class="image-container thumb active">
                                    <img style="height:50px !important;width:50px !important;" 
                                         src="assets\img\funko-pops-outside-the-box\harry-potter-otb.png" 
                                         alt="POP! HARRY POTTER">
                                </div>
                                <div id="thumb2" class="image-container thumb">
                                    <img style="height:50px !important;width:50px !important;" 
                                         src="assets/img/funko-pops-inside-the-box/harry-potter-itb.png" 
                                         alt="POP! HARRY POTTER">
                                </div>
                            </div>
                    ...
                    <div id="BuyBoxArea" class="product__data col--6">
                        <div class="wrapper">
                            ...
                            <div class="row">
                                ...
                                <h1 itemprop="name">POP! HARRY POTTER</h1>
                            ...
                            <form method="post" action="add-to-cart.php">
                                ...
                                <div class="product__qty">
                                    ...
                                    <input type="text" name="quantity_2" value="1" min="1"></label>
                                </div>

                                <div class="product__description funko-pop-text">
                                    Pop! Harry Potter is dressed in his school robes, ready to discover more about his past and himself, 
                                    in his first big endeavor away form the Dursley family. Collect Pop! Harry for your Harry Potter collection. 
                                ...
                                <div class="product__mod">
                                    <div class="product__basket">
                                        ...
                                        <script>
                                            function qtyUpdate() {
                                                document.getElementById("Qty").value = document.getElementById("quantity_2").value;
                                            }
                                        </script>
                                        ...
                                        <button id="add-to-basket" type="submit" value="2" name="add_to_cart" class="button light full-width tooltip">
