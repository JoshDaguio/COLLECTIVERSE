                    ...
                    <div class="product__images col--6">
                        ...
                        <div class="wrapper">
                            <div class="image-container" id="js-main-image-wrapper">
                                <img src="assets\img\funko-pops-outside-the-box\wolverine-otb.png" 
                                     class="js-main-image" title="POP! WOLVERINE (CLASSIC SUIT)" alt="POP! WOLVERINE (CLASSIC SUIT)" itemprop="image" />
                            </div>
                            ...
                            <div class="images__thumbs clearfix">
                                <div id="thumb1" class="image-container thumb active">
                                    <img style="height:50px !important;width:50px !important;" 
                                         src="assets\img\funko-pops-outside-the-box\wolverine-otb.png" 
                                         alt="POP! WOLVERINE (CLASSIC SUIT)">
                                </div>
                                <div id="thumb2" class="image-container thumb">
                                    <img style="height:50px !important;width:50px !important;" 
                                         src="assets\img\funko-pops-inside-the-box\wolverine-itb.png" 
                                         alt="POP! WOLVERINE (CLASSIC SUIT)">
                                </div>
                            </div>
                    ...
                    <div id="BuyBoxArea" class="product__data col--6">
                        <div class="wrapper">
                            ...
                            <div class="row">
                                ...
                                <h1 itemprop="name">POP! WOLVERINE (CLASSIC SUIT)</h1>
                                <div class="product__price" itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
                                    <span class="price" itemprop="price" content=""><span itemprop="priceCurrency" content="GBP">P</span>599.00</span>
                                </div>
                            </div>
                            ...
                            <form method="post" action="add-to-cart.php">
                                ...
                                <div class="product__qty">
                                    ...
                                    <input type="text" name="quantity_3" value="1" min="1"></label>
                                </div>

                                <div class="product__description funko-pop-text">
                                    The claws are out! Celebrate 50 years of Marvel Studios’ Wolverine with Pop! Wolverine. When all the X-Men have fallen, 
                                    Wolverine leaps into action. New adventures await with this Funko Pop! vinyl collectible of Wolverine. Build a formidable 
                                    Super Hero team and expand your Pop! Marvel set. Vinyl bobblehead is approximately 3.78 inches tall.
                                </div>
                                <hr>
                                ...
                                <div class="product__mod">
                                    <div class="product__basket">
                                        ...
                                        <script>
                                            function qtyUpdate() {
                                                document.getElementById("Qty").value = document.getElementById("quantity_3").value;
                                            }
                                        </script>
                                        ...
                                        <button id="add-to-basket" type="submit" value="3" name="add_to_cart" class="button light full-width tooltip">
