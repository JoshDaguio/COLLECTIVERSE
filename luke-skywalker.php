                    ...
                    <div class="product__images col--6">
                        ...
                        <div class="wrapper">
                            <div class="image-container" id="js-main-image-wrapper">
                                <img src="assets\img\funko-pops-outside-the-box\luke-skywalker-otb.png" 
                                     class="js-main-image" title="POP! LUKE SKYWALKER" alt="POP! LUKE SKYWALKER" itemprop="image" />
                            </div>
                            ...
                            <div class="images__thumbs clearfix">
                                <div id="thumb1" class="image-container thumb active">
                                    <img style="height:50px !important;width:50px !important;" 
                                         src="assets\img\funko-pops-outside-the-box\luke-skywalker-otb.png" 
                                         alt="POP! LUKE SKYWALKER">
                                </div>
                                <div id="thumb2" class="image-container thumb">
                                    <img style="height:50px !important;width:50px !important;" 
                                         src="assets\img\funko-pops-inside-the-box\luke-skywalker-itb.png" 
                                         alt="POP! LUKE SKYWALKER">
                                </div>
                            </div>
                    ...
                    <div id="BuyBoxArea" class="product__data col--6">
                        <div class="wrapper">
                            ...
                            <div class="row">
                                ...
                                <h1 itemprop="name">POP! LUKE SKYWALKER</h1>
                                <div class="product__price" itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
                                    <span class="price" itemprop="price" content=""><span itemprop="priceCurrency" content="GBP">P</span>699.00</span>
                                </div>
                            </div>
                            ...
                            <form method="post" action="add-to-cart.php">
                                ...
                                <div class="product__qty">
                                    ...
                                    <input type="text" name="quantity_12" value="1" min="1"></label>
                                </div>

                                <div class="product__description funko-pop-text">
                                    Celebrate the 40th Anniversary of Return of the Jedi™ with the most stellar fandom of all! Pop! Luke Skywalker™ has arrived 
                                    at Jabba the Hutt’s Palace™ to rescue his friends! Complete your Star Wars™ collection by bringing this Jedi Knight™ into 
                                    your home. Vinyl bobblehead is approximately 4.4-inches tall.
                                </div>
                                ...
                                <div class="product__mod">
                                    <div class="product__basket">
                                        ...
                                        <script>
                                            function qtyUpdate() {
                                                document.getElementById("Qty").value = document.getElementById("quantity_12").value;
                                            }
                                        </script>
                                        ...
                                        <button id="add-to-basket" type="submit" value="12" name="add_to_cart" class="button light full-width tooltip">
