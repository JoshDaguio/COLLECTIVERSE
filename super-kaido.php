                    ...
                    <div class="product__images col--6">
                        ...
                        <div class="wrapper">
                            <div class="image-container" id="js-main-image-wrapper">
                                <img src="assets\img\funko-pops-outside-the-box\super-kaido-otb.png" 
                                     class="js-main-image" title="POP! SUPER KAIDO (MAN-BEAST FORM)" alt="POP! SUPER KAIDO (MAN-BEAST FORM)" itemprop="image" />
                            </div>
                            ...
                            <div class="images__thumbs clearfix">
                                <div id="thumb1" class="image-container thumb active">
                                    <img style="height:50px !important;width:50px !important;" 
                                         src="assets\img\funko-pops-outside-the-box\super-kaido-otb.png" 
                                         alt="POP! SUPER KAIDO (MAN-BEAST FORM)">
                                </div>
                                <div id="thumb2" class="image-container thumb">
                                    <img style="height:50px !important;width:50px !important;" 
                                         src="assets\img\funko-pops-inside-the-box\super-kaido-itb.png" 
                                         alt="POP! SUPER KAIDO (MAN-BEAST FORM)">
                                </div>
                            </div>
                    ...
                    <div id="BuyBoxArea" class="product__data col--6">
                        <div class="wrapper">
                            ...
                            <div class="row">
                                ...
                                <h1 itemprop="name">POP! SUPER KAIDO (MAN-BEAST FORM)</h1>
                                <div class="product__price" itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
                                    <span class="price" itemprop="price" content=""><span itemprop="priceCurrency" content="GBP">P</span>1,475.00</span>
                                </div>
                            </div>
                            ...
                            <form method="post" action="add-to-cart.php">
                                ...
                                <div class="product__qty">
                                    ...
                                    <input type="text" name="quantity_18" value="1" min="1"></label>
                                </div>

                                <div class="product__description funko-pop-text">
                                    Set sail with the Governor-General of the Beast Pirates, Pop! Kaido! Expand your One Piece collection by adding this Super Pop! 
                                    Kaido in his Man-Beast Form to your scurvy crew! Vinyl figure is approximately 6.75-inches tall.
                                </div>
                                ...
                                <div class="product__mod">
                                    <div class="product__basket">
                                        ...
                                        <script>
                                            function qtyUpdate() {
                                                document.getElementById("Qty").value = document.getElementById("quantity_18").value;
                                            }
                                        </script>
                                        ...
                                        <button id="add-to-basket" type="submit" value="18" name="add_to_cart" class="button light full-width tooltip">
