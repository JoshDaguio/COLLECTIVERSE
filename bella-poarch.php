                    ...
                    <div class="product__images col--6">
                        ...
                        <div class="wrapper">
                            <div class="image-container" id="js-main-image-wrapper">
                                <img src="assets\img\funko-pops-outside-the-box\bella-poarch-otb.png" 
                                     class="js-main-image" title="POP! BELLA POARCH" alt="POP! BELLA POARCH" itemprop="image" />
                            </div>
                            ...
                            <div class="images__thumbs clearfix">
                                <div id="thumb1" class="image-container thumb active">
                                    <img style="height:50px !important;width:50px !important;" 
                                         src="assets\img\funko-pops-outside-the-box\bella-poarch-otb.png" 
                                         alt="POP! BELLA POARCH">
                                </div>
                                <div id="thumb2" class="image-container thumb">
                                    <img style="height:50px !important;width:50px !important;" 
                                         src="assets\img\funko-pops-inside-the-box\bella-poarch-itb.png" 
                                         alt="POP! BELLA POARCH">
                                </div>
                            </div>
                    ...
                    <div id="BuyBoxArea" class="product__data col--6">
                        <div class="wrapper">
                            ...
                            <div class="row">
                                ...
                                <h1 itemprop="name">POP! BELLA POARCH</h1>
                            ...
                            <form method="post" action="add-to-cart.php">
                                ...
                                <div class="product__qty">
                                    ...
                                    <input type="text" name="quantity_8" value="1" min="1"></label>
                                </div>

                                <div class="product__description funko-pop-text">
                                    Celebrate the record-breaking debut of an internet sensation. Pop! Bella Poarch sports an outfit from her first music video. 
                                    Who will this artist collaborate with in your music collection? Vinyl figure is approximately 4.2-inches tall.
                                </div>
                                ...
                                <div class="product__mod">
                                    <div class="product__basket">
                                        ...
                                        <script>
                                            function qtyUpdate() {
                                                document.getElementById("Qty").value = document.getElementById("quantity_8").value;
                                            }
                                        </script>
                                        ...
                                        <button id="add-to-basket" type="submit" value="8" name="add_to_cart" class="button light full-width tooltip">
