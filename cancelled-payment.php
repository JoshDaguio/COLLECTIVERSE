...
<body>
    ...
    <div class="content-wrapper wrapper full-width">
        <div class="content" role="main">
            ...
            <div class="cancelled-payment">
                <div>
                    <h1>Oops!</h1>
                    <p class="funko-pop-text">
                        We've got some bad news. It looks like you've cancelled your payment, so we could not process your order. <br />
                        <br />
                        Unfortunately, this means that your items will be cleared from your cart. If this was a mistake or you'd like 
                        to try again, please visit our website and shop again as soon as possible. <br /> 
                        <br /> 
                        We're here to assist you with any issues you might encounter. Don't hesitate to reach out to our customer support 
                        team for further assistance. <br />
                        <br />
                        Thank you for your understanding, and we hope to serve you soon.</p>
                        <a class="button checkout" href="shop.php">BACK TO HOMEPAGE</a>
                </div>
                <div>
                    <img src="assets\img\funko-pops-outside-the-box\sadness-otb.png" alt="Sadness">
                </div>
            </div>
    ...
    <script type="text/javascript">
        // Check if the PHP session cart is empty and update the localStorage basket count
