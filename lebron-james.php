                    ...
                    <div class="product__images col--6">
                        ...
                        <div class="wrapper">
                            <div class="image-container" id="js-main-image-wrapper">
                                <img src="assets\img\funko-pops-outside-the-box\lebron-james-otb.png" 
                                     class="js-main-image" title="POP! LEBRON JAMES POINTING (PURPLE JERSEY)" alt="POP! LEBRON JAMES POINTING (PURPLE JERSEY)" itemprop="image" />
                            </div>
                            ...
                            <div class="images__thumbs clearfix">
                                <div id="thumb1" class="image-container thumb active">
                                    <img style="height:50px !important;width:50px !important;" 
                                         src="assets\img\funko-pops-outside-the-box\lebron-james-otb.png" 
                                         alt="POP! LEBRON JAMES POINTING (PURPLE JERSEY)">
                                </div>
                                <div id="thumb2" class="image-container thumb">
                                    <img style="height:50px !important;width:50px !important;" 
                                         src="assets\img\funko-pops-inside-the-box\lebron-james-itb.png" 
                                         alt="POP! LEBRON JAMES POINTING (PURPLE JERSEY)">
                                </div>
                            </div>
                    ...
                    <div id="BuyBoxArea" class="product__data col--6">
                        <div class="wrapper">
                            ...
                            <div class="row">
                                ...
                                <h1 itemprop="name">POP! LEBRON JAMES POINTING (PURPLE JERSEY)</h1>
                                <div class="product__price" itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
                                    <span class="price" itemprop="price" content=""><span itemprop="priceCurrency" content="GBP">P</span>800.00</span>
                                </div>
                            </div>
                            ...
                            <form method="post" action="add-to-cart.php">
                                ...
                                <div class="product__qty">
                                    ...
                                    <input type="text" name="quantity_16" value="1" min="1"></label>
                                </div>

                                <div class="product__description funko-pop-text">
                                    Get courtside seats for Pop! LeBron James! Wearing his Los Angeles Lakers uniform, Pop! LeBron James is ready to make a slam dunk 
                                    for your NBA collection. Show off your team spirit while building your fantasy basketball team. Step up your game and collect them 
                                    all. Vinyl figure is approximately 3.82 inches tall.
                                </div>
                                ...
                                <div class="product__mod">
                                    <div class="product__basket">
                                        ...
                                        <script>
                                            function qtyUpdate() {
                                                document.getElementById("Qty").value = document.getElementById("quantity_16").value;
                                            }
                                        </script>
                                        ...
                                        <button id="add-to-basket" type="submit" value="16" name="add_to_cart" class="button light full-width tooltip">
