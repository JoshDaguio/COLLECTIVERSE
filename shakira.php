                    ...
                    <div class="product__images col--6">
                        ...
                        <div class="wrapper">
                            <div class="image-container" id="js-main-image-wrapper">
                                <img src="assets\img\funko-pops-outside-the-box\shakira-otb.png" 
                                     class="js-main-image" title="POP! SHAKIRA" alt="POP! SHAKIRA" itemprop="image" />
                            </div>
                            ...
                            <div class="images__thumbs clearfix">
                                <div id="thumb1" class="image-container thumb active">
                                    <img style="height:50px !important;width:50px !important;" 
                                         src="assets\img\funko-pops-outside-the-box\shakira-otb.png" 
                                         alt="POP! SHAKIRA">
                                </div>
                                <div id="thumb2" class="image-container thumb">
                                    <img style="height:50px !important;width:50px !important;" 
                                         src="assets\img\funko-pops-inside-the-box\shakira-itb.png" 
                                         alt="POP! SHAKIRA">
                                </div>
                            </div>
                    ...
                    <div id="BuyBoxArea" class="product__data col--6">
                        <div class="wrapper">
                            ...
                            <div class="row">
                                ...
                                <h1 itemprop="name">POP! SHAKIRA</h1>
                                <div class="product__price" itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
                                    <span class="price" itemprop="price" content=""><span itemprop="priceCurrency" content="GBP">P</span>595.00</span>
                                </div>
                            </div>
                            ...
                            <form method="post" action="add-to-cart.php">
                                ...
                                <div class="product__qty">
                                    ...
                                    <input type="text" name="quantity_7" value="1" min="1"></label>
                                </div>

                                <div class="product__description funko-pop-text">
                                    Bring home the pop icon, singer-songwriter, Shakira in her Whenever, Wherever music video outfit with Pop! Shakira!
                                    Who will this artist collaborate with in your Pop! Rocks collection? Vinyl figure is approximately 3.85-inches tall.
                                </div>
                                ...
                                <div class="product__mod">
                                    <div class="product__basket">
                                        ...
                                        <script>
                                            function qtyUpdate() {
                                                document.getElementById("Qty").value = document.getElementById("quantity_7").value;
                                            }
                                        </script>
                                        ...
                                        <button id="add-to-basket" type="submit" value="7" name="add_to_cart" class="button light full-width tooltip">
