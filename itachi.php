                    ...
                    <div class="product__images col--6">
                        ...
                        <div class="wrapper">
                            <div class="image-container" id="js-main-image-wrapper">
                                <img src="assets\img\funko-pops-outside-the-box\itachi-otb.png" 
                                     class="js-main-image" title="POP! ITACHI WITH CROWS" alt="POP! ITACHI WITH CROWS" itemprop="image" />
                            </div>
                            ...
                            <div class="images__thumbs clearfix">
                                <div id="thumb1" class="image-container thumb active">
                                    <img style="height:50px !important;width:50px !important;" 
                                         src="assets\img\funko-pops-outside-the-box\itachi-otb.png" 
                                         alt="POP! ITACHI WITH CROWS">
                                </div>
                                <div id="thumb2" class="image-container thumb">
                                    <img style="height:50px !important;width:50px !important;" 
                                         src="assets\img\funko-pops-inside-the-box\itachi-itb.png" 
                                         alt="POP! ITACHI WITH CROWS">
                                </div>
                            </div>
                    ...
                    <div id="BuyBoxArea" class="product__data col--6">
                        <div class="wrapper">
                            ...
                            <div class="row">
                                ...
                                <h1 itemprop="name">POP! ITACHI WITH CROWS</h1>
                                <div class="product__price" itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
                                    <span class="price" itemprop="price" content=""><span itemprop="priceCurrency" content="GBP">P</span>1,255.00</span>
                                </div>
                            </div>
                            ...
                            <form method="post" action="add-to-cart.php">
                                ...
                                <div class="product__qty">
                                    ...
                                    <input type="text" name="quantity_17" value="1" min="1"></label>
                                </div>

                                <div class="product__description funko-pop-text">
                                    As a skilled shinobi of the Anbu, Pop! Itachi Uchiha is prepared to do whatever it takes to protect his little brother, Sasuke. 
                                    Complete your Naruto: Shippuden collection when you welcome Pop! Itachi with Crows to your team. Vinyl figure is approximately 
                                    4.85-inches tall.
                                </div>
                                ...
                                <div class="product__mod">
                                    <div class="product__basket">
                                        ...
                                        <script>
                                            function qtyUpdate() {
                                                document.getElementById("Qty").value = document.getElementById("quantity_17").value;
                                            }
                                        </script>
                                        ...
                                        <button id="add-to-basket" type="submit" value="17" name="add_to_cart" class="button light full-width tooltip">
