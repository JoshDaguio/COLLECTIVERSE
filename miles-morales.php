                    ...
                    <div class="product__images col--6">
                        ...
                        <div class="wrapper">
                            <div class="image-container" id="js-main-image-wrapper">
                                <img src="assets\img\funko-pops-outside-the-box\miles-morales-otb.png" 
                                     class="js-main-image" title="POP! MILES MORALES UPGRADED SUIT" alt="POP! MILES MORALES UPGRADED SUIT" itemprop="image" />
                            </div>
                            ...
                            <div class="images__thumbs clearfix">
                                <div id="thumb1" class="image-container thumb active">
                                    <img style="height:50px !important;width:50px !important;" 
                                         src="assets\img\funko-pops-outside-the-box\miles-morales-otb.png" 
                                         alt="POP! MILES MORALES UPGRADED SUIT">
                                </div>
                                <div id="thumb2" class="image-container thumb">
                                    <img style="height:50px !important;width:50px !important;" 
                                         src="assets\img\funko-pops-inside-the-box\miles-morales-itb.png" 
                                         alt="POP! MILES MORALES UPGRADED SUIT">
                                </div>
                            </div>
                    ...
                    <div id="BuyBoxArea" class="product__data col--6">
                        <div class="wrapper">
                            ...
                            <div class="row">
                                ...
                                <h1 itemprop="name">POP! MILES MORALES UPGRADED SUIT</h1>
                            ...
                            <form method="post" action="add-to-cart.php">
                                ...
                                <div class="product__qty">
                                    ...
                                    <input type="text" name="quantity_4" value="1" min="1"></label>
                                </div>

                                <div class="product__description funko-pop-text">
                                    Your favorite wall-crawling hero has arrived! Swinging between skyscrapers, Pop! Miles Morales is eager to save the day in your 
                                    Spider-Man 2 collection! Assemble your team of heroes when you add him to your Marvel Gamerverse lineup as Pop! Miles Morales 
                                    (Upgraded Suit). Vinyl bobblehead is approximately 4.05-inches tall.
                                </div>
                                ...
                                <div class="product__mod">
                                    <div class="product__basket">
                                        ...
                                        <script>
                                            function qtyUpdate() {
                                                document.getElementById("Qty").value = document.getElementById("quantity_4").value;
                                            }
                                        </script>
                                        ...
                                        <button id="add-to-basket" type="submit" value="4" name="add_to_cart" class="button light full-width tooltip">
